...
export class MemberComponent implements OnInit {
  ...
  getMemberById(id: number): void {
    this.memberService.getMemberGivenID(id).subscribe((member) => {
  ...
  getMemberPartyByMemberId(id: number): void {
    ...
    this.memberService.getMemberParties().subscribe((members) => {
      let entry;
  ...
  getWebsitesById(id: number): void {
    this.memberService.getWebsites().subscribe((websites) => {
